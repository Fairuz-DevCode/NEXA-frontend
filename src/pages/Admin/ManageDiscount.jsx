...
import { Ticket, Plus, Tag, Check, ToggleLeft, ToggleRight } from 'lucide-react';
    ...
    <div className="bg-white p-6 sm:p-8 rounded-3xl border border-gray-200/90 shadow-xl shadow-gray-200/40 mb-8 font-body">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-gray-100">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-black hover:bg-gray-800 text-white px-4 py-2.5 rounded-2xl text-xs font-bold shadow-md transition-all self-start sm:self-auto"
        >
