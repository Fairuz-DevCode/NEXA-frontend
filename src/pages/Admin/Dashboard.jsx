...
const Dashboard = () => {
    ...
    Promise.all([
      ...
      .then(([prodRes, catRes]) => {
        if (isMounted) {
          ...
          const cats = catRes?.payload || catRes || [];
          setStats({
  ...
  // Sample static high-end metrics data matching reference design
  const topMetrics = [
    {
  ...
  return (
    <div className="min-h-screen bg-parchment-DEFAULT/60 py-8 px-4 sm:px-6 lg:px-10 font-body text-gray-900">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white/90 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-gray-200/80 shadow-lg shadow-gray-200/40">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button className="flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-800 px-4 py-2 rounded-2xl border border-gray-300 text-xs font-bold shadow-xs transition-all">
      ...
      {/* ======================================================== */}
      {/* 3. CHART & LIVE CURATION AUDIT STREAM (2 COLUMNS)       */}
      {/* ======================================================== */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">

        {/* Left Column: Kecepatan Transaksi & Arus Kas Harian Chart */}
        <div className="lg:col-span-8 bg-white p-6 sm:p-8 rounded-3xl border border-gray-200/90 shadow-xl shadow-gray-200/40 flex flex-col justify-between">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-2xl border border-gray-200 text-xs font-bold text-gray-600">
              <button className="px-3 py-1.5 rounded-xl bg-white text-black shadow-xs">Sneakers / Kasual</button>
              <button className="px-3 py-1.5 rounded-xl hover:text-black transition-colors">Boots & Formal</button>
            </div>
          </div>
        ...
        {/* Right Column: Log Audit Kurasi Langsung */}
        <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-3xl border border-gray-200/90 shadow-xl shadow-gray-200/40 flex flex-col justify-between">
          ...
          <button className="w-full mt-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-2xl text-xs font-bold font-label transition-colors">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Component 1: ManageProduct */}
        <ManageProduct />

        {/* Component 2: ManageOrders */}
        <ManageOrders />

        {/* Component 3: ManageDiskon */}
        <ManageDiscount />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 mt-8">
        ...
        {/* Left Card: Kredensial Super Admin */}
        <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-3xl border border-gray-200/90 shadow-xl shadow-gray-200/40 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
        ...
        {/* Right Card: Audit Log Akses & Keamanan Vault */}
