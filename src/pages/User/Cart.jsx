      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {items.map((item) => {
            ...
            const image = getImageUrl(item.product_img_url || product?.img_url || item);
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center border border-gray-200 rounded-xl bg-gray-50">
                    <button
                      ...
                      className="p-1.5 hover:bg-gray-200 rounded-l-xl text-gray-700 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 hover:bg-gray-200 rounded-r-xl text-gray-700 transition-colors"
                    >
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm h-fit">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-black text-white font-label font-bold text-sm flex items-center justify-center gap-2 hover:bg-gray-800 active:scale-98 transition-all shadow-md"
          >
