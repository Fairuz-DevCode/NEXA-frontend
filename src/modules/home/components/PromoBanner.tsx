    ...
    >
      <div className="flex flex-col items-start justify-center w-1/2 max-w-xs p-3 text-left sm:pl-8 md:max-w-sm lg:p-8">
        <div className="w-full">
          ...
          <button className="px-4 py-2 rounded-xl bg-black font-semibold text-xs text-white shadow-md transition-all hover:bg-neutral-800 hover:shadow-lg sm:px-5 sm:py-2.5 md:text-sm cursor-pointer">
            Shop Sale Now
          </button>
        </div>
      </div>
