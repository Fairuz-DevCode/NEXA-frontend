    ...
    <nav className='fixed top-0 left-0 z-50 flex items-center justify-between w-full h-14 bg-linen-600 px-4 text-parchment-100 font-body shadow-md border-b border-linen-700/20'>
      ...
      <div className="flex items-center gap-1 lg:pl-10 xl:pl-30">
        <Link to='/' className='flex items-center gap-2 hover:opacity-80 transition-opacity'>
          ...
          <div>
            <h1 className='font-bold text-sm text-parchment-100 tracking-wider font-headline'>NEXA</h1>
          </div>
        </Link>
      </div>
      ...
      <div className="flex items-center gap-3 lg:pr-10 xl:pr-30 relative z-10">
        ...
        <div className="flex items-center gap-1 lg:gap-2">
          {currentUser && (
            ...
            >
              <UserIcon className="w-4 h-4 text-parchment-100" />
                ...
                {currentUser ? (
                  <>
                    ...
                    <button
                      ...
                      className='block w-full px-3 py-2 text-left text-sm font-bold rounded-lg text-parchment-100 hover:bg-linen-700/80 cursor-pointer'
                    >
                      Logout
                    </button>
                  </>
